...
<html lang="en">
	<head>
		...
		<link rel="icon" href="{{ asset('Theme_css/images/favicon.ico')}}">
		<link rel="shortcut icon" href="{{ asset('Theme_css/images/favicon.ico')}}">
...
<!--==============================header=================================-->
		<header>
			<div class="container_12">
				<div class="grid_12">
					<h1><a href="index.html"><img  height="75" width="75" src="{{ asset('Theme_css/images/2Q.png')}}" alt="Boo House"></a></h1>
		...
		<div class="slider_wrapper">
			<div id="camera_wrap" class="">
				<div data-src="{{ asset('Theme_css/images/slide.jpg')}}"></div>
				<div data-src="{{ asset('Theme_css/images/slide1.jpg')}}"></div>
				<div data-src="{{ asset('Theme_css/images/slide2.jpg')}}"></div>
			</div>
		</div>
		<div class="container_12">
			<div class="grid_12">
...
<!--==============================Content=================================-->
		<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - February 24, 2014!</div>
			<div class="container_12">
				<div class="grid_6">
					<img src="{{ asset('Theme_css/images/page1_img1.jpg')}}" alt="" class="img_inner fleft">
