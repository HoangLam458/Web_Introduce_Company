                ...
                <div class="container-fluid justify-content-center">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation"> <a class="nav-link active" id="home-tab" data-toggle="tab"
                                href="#home" role="tab" aria-controls="home" aria-selected="true">Vật liệu xây
                                dựng</a>
                        </li>
                        <li class="nav-item" role="presentation"> <a class="nav-link" id="contact-tab" data-toggle="tab"
                                href="#contact" role="tab" aria-controls="contact" aria-selected="false">Nội thất</a>
                        </li>
                        <li class="nav-item" role="presentation"> <a class="nav-link" id="contact-tab" data-toggle="tab"
                                href="#productType" role="tab" aria-controls="contact" aria-selected="false">Thêm loại
                                sản
                                phẩm</a> </li>
                    </ul>
                </div>
            ...
            <div class="products">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="row g-3">
                            @foreach ($pr1 as $p1)
                                <div class="col-md-4">
                                    <div class="card">
                                        <a href="{{ route('admin.product.list', $p1->id) }}"> <img
                                        ...
                                        <div class="card-body">
                                            <div class="text-right buttons">
                                                <a class="btn btn-outline-dark"
                                                    onclick="location.href='{{ route('admin.product.list', $p1->id) }}'">Xem</a>
                                                <a class="btn btn-danger" type="button" onclick="return checkDelete()"
                                                    href="{{ route('productT.delete', $p1->id) }}">Xóa</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        ...
                        <div class="row g-3">
                            @foreach ($pr2 as $p2)
                                <div class="col-md-4">
                                    <div class="card">
                                        <a href="{{ route('admin.product.list', $p2->id) }}"> <img
                                                src="{{ asset('img/2.jpg') }}" class="card-img-top"></a>
                                        ...
                                        <div class="card-body">
                                            <div class="text-right buttons">
                                                <a class="btn btn-outline-dark"
                                                    onclick="location.href='{{ route('admin.product.list', $p2->id) }}'">Xem</a>
                                                <a class="btn btn-danger" type="button" onclick="return checkDelete()"
                                                    href="{{ route('productT.delete', $p2->id) }}">Xóa</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="productType" role="tabpanel" aria-labelledby="contact-tab">
                        <!--Dining-->
                        <div class="d-flex justify-content-between p-3 bg-white mb-3 align-items-center"> <span
                                class="font-weight-bold text-uppercase">Thêm Loại sản phẩm</span>
                        </div>
                        <form action="{{ route('productType.store') }}" method="POST" class="form"
                            ...
                            <div class="modal-footer">
                                ...
                                <button onclick="return checkConfirm()" type="submit" class="btn btn-primary">Xác
                                    nhận</button>
                            </div>
                        </form>
                    </div>
