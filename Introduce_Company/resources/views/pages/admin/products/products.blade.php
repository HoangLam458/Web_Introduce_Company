                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <a href="{{route('admin.product.list',$p1->id)}}"> <img src="{{ asset('img/1.jpg')}}" class="card-img-top"></a>
                                    <div class="card-body">
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                <a href="{{route('admin.product.list',$p2->id)}}"> <img src="{{ asset('img/2.jpg')}}" class="card-img-top"></a>
