                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <a href="{{route('admin.serv.show',$p1->id)}}"> <img src="{{ asset('img/1.jpg')}}" class="card-img-top"></a>
                                    <div class="card-body">
                                    ...
                                    <div class="text-right buttons">
                                        <a class="btn btn-outline-dark" onclick="location.href='{{route('admin.serv.show',$p1->id)}}'">Xem</a>
